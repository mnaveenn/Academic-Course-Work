...
%[input,Fs]=wavread('clean.wav'); 	%insert .wav file here
[input,Fs]=wavread('SpeechIEEE.wav'); 	%insert .wav file here
...
fid=fopen('SpeechIEEE.h','w');		%printing samples as array->input.h
